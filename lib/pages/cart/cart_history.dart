                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            (() {
                              DateTime parseDate =
                                  DateFormat('yyyy-MM-dd HH:mm:ss').parse(cartHistoryList[listCounter].time!);
                                        ...
                                        ? Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                  image: NetworkImage(
                                                    AppConstants.uploadURL + cartHistoryList[listCounter - 1].img!,
                                                  ),
                                                  fit: BoxFit.cover),
                                            ),
                                          )
                                ...
                                SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      LargeText(
                                          text: orderTimesList[i].toString() + ' items', color: AppColors.titleColor),
                                      GestureDetector(
                                        onTap: () {
